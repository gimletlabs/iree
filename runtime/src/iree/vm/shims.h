...
IREE_VM_ABI_FIXED_STRUCT(rrIrIIiI, {
  iree_vm_ref_t r0;
  iree_vm_ref_t r1;
  int64_t i2;
  iree_vm_ref_t r3;
...
IREE_VM_ABI_FIXED_STRUCT(riirIrIII, {
  iree_vm_ref_t r0;
  int32_t i1;
  int32_t i2;
  iree_vm_ref_t r3;
...
IREE_VM_ABI_FIXED_STRUCT(rrIIiIiI, {
  iree_vm_ref_t r0;
  iree_vm_ref_t r1;
  int64_t i2;
  int64_t i3;
...
IREE_VM_ABI_FIXED_STRUCT(rIrrrIIIiI, {
  iree_vm_ref_t r0;
  int64_t i1;
  iree_vm_ref_t r2;
  iree_vm_ref_t r3;
...
IREE_VM_ABI_FIXED_STRUCT(rIrrI, {
  iree_vm_ref_t r0;
  int64_t i1;
  iree_vm_ref_t r2;
  iree_vm_ref_t r3;
...
IREE_VM_ABI_FIXED_STRUCT(rIrrrI, {
  iree_vm_ref_t r0;
  int64_t i1;
  iree_vm_ref_t r2;
  iree_vm_ref_t r3;
...
IREE_VM_ABI_VLA_STRUCT(rIrrrICrIID, a6_count, a6, {
  iree_vm_ref_t r0;
  int64_t i1;
  iree_vm_ref_t r2;
  iree_vm_ref_t r3;
  iree_vm_ref_t r4;
  int64_t i5;
  iree_vm_size_t a6_count;
  iree_vm_abi_rII_t a6[0];
});
...
IREE_VM_ABI_VLA_STRUCT(iiICrID, a3_count, a3, {
  int32_t i0;
  int32_t i1;
  int64_t i2;
  iree_vm_size_t a3_count;
...
IREE_VM_ABI_VLA_STRUCT(iICrD, a2_count, a2, {
  int32_t i0;
  int64_t i1;
  iree_vm_size_t a2_count;
  iree_vm_abi_r_t a2[0];
...
IREE_VM_ABI_DECLARE_SHIM(rrIrIIiI, v);
